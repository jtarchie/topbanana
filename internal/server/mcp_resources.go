...
// class vocabulary, and how to switch palettes. Body lives in design_guide.md
// so the code fences read naturally instead of being concatenated around
// backtick boundaries.
//
//go:embed design_guide.md
var mcpDesignGuide string
