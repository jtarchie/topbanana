...
var nouns = []string{
	"ant", "arc", "ash", "bay", "bear", "bee", "bird", "brook",
	...
	"lark", "leaf", "lion", "lynx", "mare", "marsh", "mink", "mole",
	"moon", "moose", "moth", "mule", "nest", "newt", "owl", "path",
	...
	"trout", "vale", "vole", "wave", "weasel", "wolf", "wren", "yak",
}
